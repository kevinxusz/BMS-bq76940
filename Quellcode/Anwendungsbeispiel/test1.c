...
{
//	Balancing(cellV);
//	_delay_ms(2000); // nicht bei UART-Ausgabe
...
//	registerWrite(SYS_CTRL2, (registerRead(SYS_CTRL2) & ~(CC_EN)));	// clear
	registerWrite(SYS_CTRL2, (CC_ONESHOT));
	_delay_ms(1000);
